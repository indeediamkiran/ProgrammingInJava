...
class RegistrationFormAWT extends Frame {
	...
	public RegistrationFormAWT() {
		...
		txtName.setBounds(450,100,400,30);
        add(txtName);
		...
		Hobbies1=new Checkbox("Swimming");
		Hobbies1.setBounds(400, 350, 100, 50);	
		add(Hobbies1);
 
		Hobbies2=new Checkbox("Cooking");
